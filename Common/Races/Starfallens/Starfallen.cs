...
using StarfallenRace.Content.Buffs;

namespace StarfallenRace.Common.Races.Starfallens
{
	public class Starfallen : Race
    {
		...
		public override string RaceSelectIcon => ($"StarfallenRace/Common/UI/RaceDisplay/Starfallen_Select");
		public override string RaceDisplayMaleIcon => ($"StarfallenRace/Common/UI/RaceDisplay/Starfallen_Display_Male");
		public override string RaceDisplayFemaleIcon => ($"StarfallenRace/Common/UI/RaceDisplay/Starfallen_Display_Female");

		public override string RaceDisplayName => "The Starfallen";
		public override string RaceLore1 => "The Starfallen are " + "\nhumanoid creatures " + "\ninfected by the " + "\nAstral Infection.";
		public override string RaceLore2 => "They show no emotion, only " + "\nseeking to infect more " + "\nunfortunate souls.";

		public override string RaceEnvironmentIcon => ($"StarfallenRace/Common/UI/RaceDisplay/Environment/Environment_Astral");
		...
		public override string RaceAbilityName => "Stellar Speed";
		public override string RaceAbilityDescription1 => "Press [c/34EB93:Racial Ability Hotkey] to temporarily increase your movement capabilities at the cost of your damage output.";
		public override string RaceAbilityDescription2 => "Increases your movement speed by [c/34EB92:50%] and jump height by [c/34EB92:100%]";
		public override string RaceAbilityDescription3 => "Decreases your damage by [c/FF4F64:10%]";
		public override string RaceAbilityDescription4 => "Lasts for 10 seconds, 30 second cooldown";
		public override string RaceAbilityDescription5 => "";
		public override string RaceAbilityDescription6 => "";
		public override string RaceAdditionalNotesDescription1 => "-Benefits from [c/34EB03:+30%] throwing damage (effectively [c/34EB03:+15%]) despite not appearing in the stats section because of the lack of a throwing damage icon";

		public override string RaceJumpSpeedDisplayText => "[c/34EB93:+75%]";
		public override string RaceFallDamageResistanceDisplayText => "[c/34EB93:25]";
		public override string RaceRegenerationDisplayText => "[c/34EB93:+1]";
        ...
        {
						var StarfallenRace = ModLoader.GetMod("StarfallenRace");
						Main.PlaySound(SoundLoader.customSoundType, (int)player.Center.X, (int)player.Center.Y, StarfallenRace.GetSoundSlot(SoundType.Custom, "Sounds/Starfallen_Killed"));
			return true;
		}	
		...
		public override void ProcessTriggers(Player player, Mod mod)
        {
			...
			if (modPlayer.RaceStats)
            {
                ...
                {
					if (!player.HasBuff(ModContent.BuffType<StellarCooldown>()))
                    {
						Main.PlaySound(SoundLoader.customSoundType, (int)player.Center.X, (int)player.Center.Y, StarfallenRace.GetSoundSlot(SoundType.Custom, "Sounds/StellarSpeedAbility"), 1);
						player.AddBuff(ModContent.BuffType<StellarSpeed>(), 600);
						player.AddBuff(ModContent.BuffType<StellarCooldown>(), 1800);
					}
		...
		public override void PreUpdate(Player player, Mod mod)
        {
			...
			if (player.HasBuff(_MrPlagueRaces.BuffType("DetectHurt")) && (player.statLife != player.statLifeMax2))
            {
                ...
                {
						Main.PlaySound(SoundLoader.customSoundType, (int)player.Center.X, (int)player.Center.Y, StarfallenRace.GetSoundSlot(SoundType.Custom, "Sounds/Starfallen_Hurt"));
                }
				else if (!player.Male && HasFemaleHurtSound)
                {
						Main.PlaySound(SoundLoader.customSoundType, (int)player.Center.X, (int)player.Center.Y, StarfallenRace.GetSoundSlot(SoundType.Custom, "Sounds/Starfallen_Hurt_Female"));
				}
				else
                {
						Main.PlaySound(SoundLoader.customSoundType, (int)player.Center.X, (int)player.Center.Y, StarfallenRace.GetSoundSlot(SoundType.Custom, "Sounds/Starfallen_Hurt"));
			...
			public override void ModifyDrawInfo(Player player, Mod mod, ref PlayerDrawInfo drawInfo)
		{
				...
				{
					modPlayer.resetDefaultColors = true;
		...
		public override void ModifyDrawLayers(Player player, List<PlayerLayer> layers)
		{
			...
			Main.playerTextures[0, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head");
			Main.playerTextures[0, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2");
			Main.playerTextures[0, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes");
			Main.playerTextures[0, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso");
			...
			Main.playerTextures[0, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands");
			...
			Main.playerTextures[0, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm");
			...
			Main.playerTextures[0, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand");
			Main.playerTextures[0, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs");
			...
			Main.playerTextures[1, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head");
			Main.playerTextures[1, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2");
			Main.playerTextures[1, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes");
			Main.playerTextures[1, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso");
			...
			Main.playerTextures[1, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands");
			...
			Main.playerTextures[1, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm");
			...
			Main.playerTextures[1, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand");
			Main.playerTextures[1, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs");
			...
			Main.playerTextures[2, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head");
			Main.playerTextures[2, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2");
			Main.playerTextures[2, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes");
			Main.playerTextures[2, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso");
			...
			Main.playerTextures[2, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands");
			...
			Main.playerTextures[2, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm");
			...
			Main.playerTextures[2, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand");
			Main.playerTextures[2, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs");
			...
			Main.playerTextures[3, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head");
			Main.playerTextures[3, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2");
			Main.playerTextures[3, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes");
			Main.playerTextures[3, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso");
			...
			Main.playerTextures[3, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands");
			...
			Main.playerTextures[3, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm");
			...
			Main.playerTextures[3, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand");
			Main.playerTextures[3, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs");
			...
			Main.playerTextures[8, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head");
			Main.playerTextures[8, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2");
			Main.playerTextures[8, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes");
			Main.playerTextures[8, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso");
			...
			Main.playerTextures[8, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands");
			...
			Main.playerTextures[8, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm");
			...
			Main.playerTextures[8, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand");
			Main.playerTextures[8, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs");
			...
			Main.playerTextures[4, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head_Female");
			Main.playerTextures[4, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2_Female");
			Main.playerTextures[4, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_Female");
			Main.playerTextures[4, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso_Female");
			...
			Main.playerTextures[4, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands_Female");
			...
			Main.playerTextures[4, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm_Female");
			...
			Main.playerTextures[4, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand_Female");
			Main.playerTextures[4, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs_Female");
			...
			Main.playerTextures[5, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head_Female");
			Main.playerTextures[5, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2_Female");
			Main.playerTextures[5, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_Female");
			Main.playerTextures[5, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso_Female");
			...
			Main.playerTextures[5, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands_Female");
			...
			Main.playerTextures[5, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm_Female");
			...
			Main.playerTextures[5, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand_Female");
			Main.playerTextures[5, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs_Female");
			...
			Main.playerTextures[6, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head_Female");
			Main.playerTextures[6, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2_Female");
			Main.playerTextures[6, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_Female");
			Main.playerTextures[6, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso_Female");
			...
			Main.playerTextures[6, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands_Female");
			...
			Main.playerTextures[6, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm_Female");
			...
			Main.playerTextures[6, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand_Female");
			Main.playerTextures[6, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs_Female");
			...
			Main.playerTextures[7, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head_Female");
			Main.playerTextures[7, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2_Female");
			Main.playerTextures[7, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_Female");
			Main.playerTextures[7, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso_Female");
			...
			Main.playerTextures[7, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands_Female");
			...
			Main.playerTextures[7, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm_Female");
			...
			Main.playerTextures[7, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand_Female");
			Main.playerTextures[7, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs_Female");
			...
			Main.playerTextures[9, 0] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Head_Female");
			Main.playerTextures[9, 1] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_2_Female");
			Main.playerTextures[9, 2] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Eyes_Female");
			Main.playerTextures[9, 3] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Torso_Female");
			...
			Main.playerTextures[9, 5] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hands_Female");
			...
			Main.playerTextures[9, 7] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Arm_Female");
			...
			Main.playerTextures[9, 9] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Hand_Female");
			Main.playerTextures[9, 10] = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Legs_Female");
			...
			Main.ghostTexture = ModContent.GetTexture("StarfallenRace/Content/RaceTextures/Starfallen/Starfallen_Ghost");
		}
